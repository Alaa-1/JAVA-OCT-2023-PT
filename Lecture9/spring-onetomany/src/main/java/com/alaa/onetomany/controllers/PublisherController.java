package com.alaa.onetomany.controllers;
...
import com.alaa.onetomany.services.PublisherService;
...
public class PublisherController {
	...
	public String publishers(@ModelAttribute("publisher")Publisher publisher) {
		...
		return "create_publihser.jsp";
	}


	@PostMapping("/publishers")
	public String process_publisher_form(@Valid @ModelAttribute("publisher") Publisher publisher, BindingResult result) {
